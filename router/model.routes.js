...
const { getAllModels, getOneModel, getModelsByBrand, addModel, updateModel, deleteModel } = require("../controller/model.controller")
...
Modelrouter.get("/get_models_by_brand/:brandId", authorization, getModelsByBrand)
